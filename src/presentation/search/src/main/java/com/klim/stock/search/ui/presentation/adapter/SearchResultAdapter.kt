package com.klim.stock.search.ui.presentation.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.klim.stock.search.ui.databinding.SearchItemBinding
import com.klim.stock.search.ui.presentation.SearchResultView
...
class SearchResultAdapter : RecyclerView.Adapter<SearchResultViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchResultViewHolder {
        ...
        vh.binding.container.setOnClickListener {it ->
